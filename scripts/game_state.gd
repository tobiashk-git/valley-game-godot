...
var boss_defeated: Dictionary = {"dungeon_boss": false, "castle_boss": false, "final_boss": false, "frostpeak_boss": false, "verdantwood_boss": false}
...
var discovered_pois: Dictionary = {"house": true, "village": true, "dungeon": false, "castle": false, "frostpeak_interior": false, "verdantwood_interior": false}
