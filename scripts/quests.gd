...
const QUEST_DEFS := {
	...
	"open_ancient_barrow": {
		...
		"objective": {"type": "gather", "item_id": "stone", "amount": 6, "goal": "Bring the Elder 6 Stone to shore up the barrow's collapsed entrance. Buy the leather set from the Blacksmith while you gather."},
		"reward": {"xp": 90, "gold": 40, "item_id": "healing_potion", "item_amount": 1},
		"dialogue": {
			"offer": "There's an old barrow at the edge of the valley - sealed for as long as anyone remembers. Bring me 6 Stone to shore up its collapsed entrance and I'll show you where it lies. And traveler: the Blacksmith sells leather gear. Buy the whole set before you go down. Every piece.",
			"in_progress": "Still need 6 Stone for the barrow's entrance. And get that leather from the Blacksmith - armour, cap, greaves, boots, gloves. All of it.",
	...
	"hunt_barrow": {
		...
		"objective": {"type": "defeat_bosses", "boss_ids": ["golden_plains_boss"], "label": "Barrow Warden asleep", "goal": "Go down into the Ancient Barrow, learn its ways, and put the Barrow Warden to sleep. Wear the whole leather set (the Blacksmith sells it)."},
		"reward": {"xp": 100, "gold": 40, "item_id": "healing_potion", "item_amount": 1},
		"dialogue": {
			"offer": "The barrow's open. Something stirs at the bottom of it - the Barrow Warden, the old stories call it. Go down, find your feet, and put it to sleep. Full leather, mind: armour, cap, greaves, boots and gloves. The Blacksmith has them all.",
			"in_progress": "The Barrow Warden still stirs. If it keeps throwing you out, you're missing a piece of leather - the Blacksmith stocks the lot.",
