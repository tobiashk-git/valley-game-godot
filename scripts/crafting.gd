...
const RECIPES := {
	...
	"frost_gloves": {"result": "frost_gloves", "amount": 1, "cost": {"frost_shard": 1, "monster_fur": 1}},
	...
	"ironwood_gloves": {"result": "ironwood_gloves", "amount": 1, "cost": {"ironwood": 1, "monster_fur": 1}},
	...
	"ember_gloves": {"result": "ember_gloves", "amount": 1, "cost": {"ember_core": 1, "ironwood": 1}},
	...
	"bogiron_gloves": {"result": "bogiron_gloves", "amount": 1, "cost": {"bog_iron": 1, "monster_fur": 1}},
}
