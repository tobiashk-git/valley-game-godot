...
const SHOP_STOCK := ["healing_potion", "mana_potion", "antidote", "angel_feather", "leather_armor", "leather_cap", "leather_greaves", "leather_boots", "leather_gloves", "charm_of_warding"]
