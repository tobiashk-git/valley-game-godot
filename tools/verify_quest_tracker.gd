...
func _initialize() -> void:
	...
	await process_frame
	print("Pane shows the selected quest's giver, goal, progress and reward: ", journal.quest_name.text == "A Village in Need" and journal.quest_giver.text.begins_with("From the Village Elder") and journal.quest_giver.text.ends_with("follows Meet the Village") and journal.quest_goal.text.begins_with("Gather 5") and journal.quest_progress.text.begins_with("Progress: 0/5") and journal.quest_reward.text == "Reward: 40 XP, 20 gold, 1 Healing Potion")
