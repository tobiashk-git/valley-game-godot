...
func _initialize() -> void:
	...
	# Real gatehouse art since 2026-09-07 (Leonardo, keyed): 192x177, solid from the tower tops to the tile bottom.
	_build_sprite_prop("CastleEntrance", "res://assets/castle_entrance.png", 192.0, 177.0, 1.0, Rect2(), 1, true)
