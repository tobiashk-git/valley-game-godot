...
func _initialize() -> void:
	...
	quests.quest_state["hunt_verdantwood"] = "completed" # the story runs in order (2026-09-08): this ford needs the previous chapter's hunt
	...
	print("Ford walkable LIVE in this same scene, no reload needed: ", terrain0.get_cell_source_id(world.BIOME_FORDS[world.Zone.BADLANDS]) == world.SRC_FORD)
