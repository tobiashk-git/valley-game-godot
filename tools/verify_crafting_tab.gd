...
func _initialize() -> void:
	...
	print("All three potions in the first section, every gear recipe (3 starters + 8 biome tier pieces + 16 set pieces) in the second: ", potion_section.get_child_count() == 3 and armor_section.get_child_count() == 27)
