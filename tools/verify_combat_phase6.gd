...
func _initialize() -> void:
	...
	print("Frost Pick obtained (the Bone Lord's drop since 2026-09-08 - the +6 greatsword made two weapon tiers redundant): ", inventory.get_count("frost_pick") == 1 and inventory.get_count("bone_greatsword") == 0)
	print("Frost Pick stat suffix: ", items.describe_stats("frost_pick"))
	character.equip("weapon", "frost_pick")
	print("Equipping the Frost Pick works: ", character.equipped_id("weapon") == "frost_pick")
	await process_frame
