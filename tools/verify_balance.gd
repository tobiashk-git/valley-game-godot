...
func _initialize() -> void:
	...
	print("Bosses climb x1.25 a tier in HP with the set-rule + companions attacks (Bone Lord unchanged 60/8, Revenant 88/14, Bogmaw 195/38), the Ancient Warden held at tier 2 (234/27): ", b.dungeon_boss.max_hp == 60 and b.dungeon_boss.attack == 8 and b.frostpeak_boss.max_hp == 88 and b.frostpeak_boss.attack == 14 and b.gloomfen_boss.max_hp == 195 and b.gloomfen_boss.attack == 38 and b.final_boss.max_hp == 234 and b.final_boss.attack == 27)
