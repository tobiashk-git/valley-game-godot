...
func _initialize() -> void:
	...
	print("Frostpeak is one ladder step (frost wolf 17 HP / 9 ATK), Gloomfen four plus the set-rule x1.4 and the companions x1.2 (spectral undead 66 / 26): ", e.frost_wolf.max_hp == 17 and e.frost_wolf.attack == 9 and e.spectral_undead.max_hp == 66 and e.spectral_undead.attack == 26)
	var b: Dictionary = enemies.BOSSES
	print("Bosses climb x1.25 a tier in HP with the set-rule + companions attacks (Bone Lord 105/8 since the chapter-1 pass, Revenant 88/14, Bogmaw 195/38), the Ancient Warden held at tier 2 (234/27): ", b.dungeon_boss.max_hp == 105 and b.dungeon_boss.attack == 8 and b.frostpeak_boss.max_hp == 88 and b.frostpeak_boss.attack == 14 and b.gloomfen_boss.max_hp == 195 and b.gloomfen_boss.attack == 38 and b.final_boss.max_hp == 234 and b.final_boss.attack == 27)
